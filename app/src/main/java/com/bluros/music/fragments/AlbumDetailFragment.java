...
public class AlbumDetailFragment extends Fragment {
            ...
            public void onClick(View v) {
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        MusicPlayer.playAll(getActivity(), adapter.getSongIds(), 0, albumID, MusicUtils.IdType.Album, true);
    ...
    private void setAlbumart() {
        ImageLoader.getInstance().displayImage(MusicUtils.getAlbumArtUri(albumID).toString(), albumArt,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                    ...
                    public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                        ...
                        MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(context)
                                ...
                                .setColor(MusicUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                                                          ...
                                                                          public void onGenerated(Palette palette) {
                                                                              ...
                                                                              MaterialDrawableBuilder builder = MaterialDrawableBuilder.with(getActivity())
                                                                                      ...
                                                                                      .setSizeDp(30);
                                                                              if (primaryColor != -1) {
                                                                                  builder.setColor(MusicUtils.getBlackWhiteColor(primaryColor));
                                                                                  ATEUtils.setFabBackgroundTint(fab, primaryColor);
                                                                                  fab.setImageDrawable(builder.build());
                                                                              } else {
                                                                                  if (context != null) {
                                                                                      ATEUtils.setFabBackgroundTint(fab, Config.accentColor(context, Helpers.getATEKey(context)));
                                                                                      builder.setColor(MusicUtils.getBlackWhiteColor(Config.accentColor(context, Helpers.getATEKey(context))));
                                                                                      fab.setImageDrawable(builder.build());
                                                                                  }
                                                                              }
                                                                          }
