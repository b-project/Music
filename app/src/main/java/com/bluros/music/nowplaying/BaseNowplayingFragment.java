...
import com.bluros.music.adapters.BaseQueueAdapter;
import com.bluros.music.dataloaders.QueueLoader;
import com.bluros.music.listeners.MusicStateListener;
import com.bluros.music.timely.TimelyView;
import com.bluros.music.utils.Helpers;
import com.bluros.music.utils.MusicUtils;
import com.bluros.music.widgets.CircularSeekBar;
import com.bluros.music.widgets.DividerItemDecoration;
import com.bluros.music.widgets.PlayPauseButton;
import com.bluros.music.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(MusicUtils.makeShortTimeString(getActivity(), position / 1000));
            }
    ...
    public Runnable mUpdateElapsedTime = new Runnable() {
        ...
        public void run() {
            if (getActivity() != null) {
                String time = MusicUtils.makeShortTimeString(getActivity(), MusicPlayer.position() / 1000);
                if (time.length() < 5) {
    ...
    public void setSongDetails(View view) {
        ...
        if (playPauseFloating != null) {
            playPauseDrawable.setColorFilter(MusicUtils.getBlackWhiteColor(accentColor), PorterDuff.Mode.MULTIPLY);
    ...
    public void updateSongDetails() {
        ...
        if (songduration != null && getActivity() != null)
            songduration.setText(MusicUtils.makeShortTimeString(getActivity(), MusicPlayer.duration() / 1000));
