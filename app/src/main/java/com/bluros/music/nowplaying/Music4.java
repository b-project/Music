...
import com.bluros.music.adapters.Music4QueueAdapter;
import com.bluros.music.dataloaders.QueueLoader;
import com.bluros.music.utils.ImageUtils;

import net.steamcrafted.materialiconlib.MaterialDrawableBuilder;

public class Music4 extends BaseNowplayingFragment {

    ImageView mBlurredArt;
    RecyclerView horizontalRecyclerview;
    Music4QueueAdapter horizontalAdapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_music4, container, false);
    ...
    private void setupHorizontalQueue() {
        ...
        horizontalAdapter = new Music4QueueAdapter(getActivity(), QueueLoader.getQueueSongs(getActivity()));
