...
package com.bluros.music.dataloaders;
...
public class PlaylistLoader {
    ...
    private static void makeDefaultPlaylists(Context context) {
        ...
        /* Top Tracks */
        final Playlist topTracks = new Playlist(MusicUtils.PlaylistType.TopTracks.mId,
                resources.getString(MusicUtils.PlaylistType.TopTracks.mTitleId), -1);
