...
public class Constants {
    ...
    public static final String TIMBER1 = "music1";
    public static final String TIMBER2 = "music2";
    public static final String TIMBER3 = "music3";
    public static final String TIMBER4 = "music4";
