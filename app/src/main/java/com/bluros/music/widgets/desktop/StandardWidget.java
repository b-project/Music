package com.bluros.music.widgets.desktop;
...
public class StandardWidget extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(MusicUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString());
        if (artwork == null) {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action != null && action.startsWith("com.bluros.music.")) {
