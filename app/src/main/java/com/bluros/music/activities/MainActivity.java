...
import com.bluros.music.fragments.AlbumDetailFragment;
import com.bluros.music.fragments.ArtistDetailFragment;
import com.bluros.music.fragments.MainFragment;
import com.bluros.music.fragments.PlaylistFragment;
import com.bluros.music.fragments.QueueFragment;
import com.bluros.music.permissions.Nammu;
import com.bluros.music.permissions.PermissionCallback;
import com.bluros.music.slidinguppanel.SlidingUpPanelLayout;
import com.bluros.music.subfragments.QuickControlsFragment;
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "Music will need to read external storage to display songs on your device.",
