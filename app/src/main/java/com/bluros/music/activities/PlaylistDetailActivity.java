...
import com.bluros.music.dataloaders.LastAddedLoader;
import com.bluros.music.dataloaders.PlaylistSongLoader;
import com.bluros.music.dataloaders.SongLoader;
import com.bluros.music.dataloaders.TopTracksLoader;
...
public class PlaylistDetailActivity extends BaseThemedActivity implements ATEActivityThemeCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (MusicUtils.isLollipop() && PreferencesUtility.getInstance(this).getAnimations()) {
    ...
    private void setAlbumart() {
        ...
        loadBitmap(MusicUtils.getAlbumArtUri(getIntent().getExtras().getLong(Constants.ALBUM_ID)).toString());
    }
    ...
    private void setRecyclerViewAapter() {
        ...
        if (MusicUtils.isLollipop() && PreferencesUtility.getInstance(mContext).getAnimations()) {
