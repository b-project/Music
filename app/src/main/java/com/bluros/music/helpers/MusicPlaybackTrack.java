...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public MusicUtils.IdType mSourceType;
    ...
    public MusicPlaybackTrack(long id, long sourceId, MusicUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = MusicUtils.IdType.getTypeById(in.readInt());
