...
public class SubStyleSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                styleImage.setImageResource(R.drawable.music_1_nowplaying_x);
                break;
            case 1:
                styleImage.setImageResource(R.drawable.music_2_nowplaying_x);
                break;
            case 2:
                styleImage.setImageResource(R.drawable.music_3_nowplaying_x);
                break;
            case 3:
                styleImage.setImageResource(R.drawable.music_4_nowplaying_x);
                break;
        }
