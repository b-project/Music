...
import com.bluros.music.nowplaying.BaseNowplayingFragment;
...
public class QuickControlsFragment extends BaseNowplayingFragment implements MusicStateListener {
    ...
    public void updateNowplayingCard() {
        ...
        if (!duetoplaypause) {
            ImageLoader.getInstance().displayImage(MusicUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), mAlbumArt,
