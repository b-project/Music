...
public class Music4QueueAdapter extends RecyclerView.Adapter<Music4QueueAdapter.ItemHolder> {
    ...
    public Music4QueueAdapter(Activity context, List<Song> arraylist) {
    ...
    public ItemHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_queue_music4_bottom, null);
