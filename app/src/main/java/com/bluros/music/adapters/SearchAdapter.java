...
package com.bluros.music.adapters;
...
import com.bluros.music.lastfmapi.LastFmClient;
import com.bluros.music.lastfmapi.callbacks.ArtistInfoListener;
import com.bluros.music.lastfmapi.models.ArtistQuery;
import com.bluros.music.lastfmapi.models.LastfmArtist;
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        switch (getItemViewType(i)) {
            case 0:
                ...
                ImageLoader.getInstance().displayImage(MusicUtils.getAlbumArtUri(song.albumId).toString(), itemHolder.albumArt,
            ...
            case 1:
                ...
                ImageLoader.getInstance().displayImage(MusicUtils.getAlbumArtUri(album.id).toString(), itemHolder.albumArt,
                        new DisplayImageOptions.Builder().cacheInMemory(true)
                                .cacheOnDisk(true)
                                .showImageOnFail(R.drawable.ic_empty_music2)
                                .resetViewBeforeLoading(true)
            ...
            case 2:
                ...
                itemHolder.albumsongcount.setText(MusicUtils.makeCombinedString(mContext, albumNmber, songCount));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            case R.id.popup_song_play:
                                MusicPlayer.playAll(mContext, song, 0, -1, MusicUtils.IdType.NA, false);
                                break;
                            case R.id.popup_song_play_next:
                                MusicPlayer.playNext(mContext, song, -1, MusicUtils.IdType.NA);
                                break;
                            ...
                            case R.id.popup_song_addto_queue:
                                MusicPlayer.addToQueue(mContext, song, -1, MusicUtils.IdType.NA);
                                break;
